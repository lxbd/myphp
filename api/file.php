...
$auth_users = array(
    'lx8d' => '$2y$10$XVMH1qh6yiEMvA9ext20Be.Y9kSBEwTAYXGdUWn98HlrfPVPl5j2K', //whj0418209
    'whj' => '$2y$10$CpYVfLUq1lRpc/FImlNUM.okeLl5yGSWuKGIuP4xE7rRcPoEzprzC' //15047577797
);
...
<!--帮助调整位置到此--!>                            <a title="<?php echo lng('Help') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;help=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lng('Help') ?></a>
                            <?php endif ?>
<!--帮助调整位置向上--!>
